...
import { Download, Mail, MessageCircle, Linkedin, Github } from "lucide-react";
...
export function Hero({ onChatOpen }: HeroProps) {
  ...
  const handleDownloadCV = () => {
    // This will be implemented when CV file is available
  ...
  return (
    <section id="hero" className="min-h-screen flex items-center justify-center relative overflow-hidden circuit-bg">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-gradient-to-br from-secondary to-accent rounded-full blur-3xl opacity-20 animate-float" style={{ animationDelay: "1s" }}></div>
      </div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="animate-fade-in">
          ...
          <p className="text-lg sm:text-xl mb-8 text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            ...
            Passionate about innovative semiconductor solutions and cutting-edge technology.
          </p>

...
export function Contact() {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      action: () =>
        window.open(
          "https://linkedin.com/in/pham-tuan-minh-304928322",
          "_blank"
        ),
    },
  ];
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Interested in collaboration, internship opportunities, or have
            questions about my work? I'd love to hear from you.
          </p>
        </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                {contactInfo.map((info, index) => (
                  <Card
                    key={index}
                    className={`bg-gradient-card border-border/50 shadow-card hover:shadow-floating transition-all duration-300 group ${
            ...
            <Card className="bg-gradient-card border-border/50 shadow-card">
              ...
              <CardContent>
                <p className="text-muted-foreground leading-relaxed">
                  I'm always excited to discuss new opportunities in analog IC
                  design, power management circuits, or any interesting projects
                  in the semiconductor field. Whether you're looking for an
                  intern, collaborator, or just want to chat about technology,
